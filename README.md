...
* [x] Automatic brightness with light sensor
* [x] Three watchface animation types:
    ...
    * [x] Inverted Analog: two rings light up, hands are dark
* [x] Settings in web\_server or HASS
    * [x] Select watchplate animation type
...
* If you're not using Home Assistant, follow guide to [Install ESPHome Manually](https://esphome.io/guides/installing_esphome)
...
* Without light sensor, remove the "sensor:" part and reduce default brightness to 50%.
...
My hardware:
* Wemos D1 mini v4
* ds1307 attached with qwiic connector
* bh1750 light sensor chained to rtc
...
The mounting board has holes for LED ring connections and light sensor, all other electronics are mounted to the back of that board.
